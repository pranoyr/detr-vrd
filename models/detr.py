...
class DETR(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_prd_classes, num_queries, aux_loss=False):
        ...
        self.query_embed = nn.Parameter(torch.randn(num_queries, 3, hidden_dim//3))
...
def build(args):
    ...
    if args.masks:
        losses += ["masks"]
    criterion = SetCriterion(num_classes, num_prd_classes, matcher=matcher, weight_dict=weight_dict,
